...
namespace Bots.DungeonBuddy.Dungeon_Scripts.Mists_of_Pandaria
{
	...
	public override void OnEnter()
	{
		...
		public Func<WoWUnit, Task<bool>> ShaOfDoubtEncounter()
		{
            ...
            var leftDoorEdge = new WoWPoint(921.5688, -2627.169, 185.1258);
            var rightDoorEdge = new WoWPoint(897.0929, -2619.158, 185.1258);

            var pointInsideRoom = WoWMathHelper.GetRandomPointInCircle(new WoWPoint(904.97, -2634.368, 185.1812), 5);
				...
				// tank the corrupt Living waters in the back
						new Decorator(
							...
							new PrioritySelector(
								...
								new Decorator(
									ctx => Me.Location.DistanceSqr(safeLoc) <= 4 * 4 && Me.CurrentTargetGuid.IsValid && !Me.CurrentTarget.IsWithinMeleeRange,
									new PrioritySelector(
				...
				// don't stand in the pools.
						new Decorator(
							...
							new PrioritySelector(
								ctx =>
								safeLoc =
								WiseMariSafeSpots.OrderBy(l => l.DistanceSqr(Me.IsMelee() && Me.CurrentTargetGuid.IsValid ? Me.CurrentTarget.Location : Me.Location))
