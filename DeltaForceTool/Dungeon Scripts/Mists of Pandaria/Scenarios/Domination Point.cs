...
namespace Bots.DungeonBuddy.Dungeon_Scripts.Mists_of_Pandaria
{
	public class DominationPoint : Dungeon
	{
		...
		public override void IncludeTargetsFilter(List<WoWObject> incomingunits, HashSet<WoWObject> outgoingunits)
		{
			...
			var kromtharsTargetGuid = kromthar != null ? kromthar.CurrentTargetGuid : WoWGuid.Empty;

			var generalNazgrim = GeneralNazgrim;
			var generalNazgrimsTargetGuid = generalNazgrim != null ? generalNazgrim.CurrentTargetGuid : WoWGuid.Empty;

			var warlordBloodhilt = WarlordBloodhilt;
			var warlordBloodhiltsTargetGuid = warlordBloodhilt != null ? warlordBloodhilt.CurrentTargetGuid : WoWGuid.Empty;
