	...
	public class StratholmeMainGate : Dungeon
	{
        ...
        public override void IncludeLootTargetsFilter(List<WoWObject> incomingObjects, HashSet<WoWObject> outgoingunits)
        {
            foreach (var obj in incomingObjects)
            {
                ...
                if (gObj != null && (gObj.Entry == BlacksmithingPlansId || gObj.Entry == UnfinishedPaintingId)
                    && ScriptHelpers.SupportsQuesting && gObj.DistanceSqr < 35*35
	    ...
	    private const uint BlacksmithingPlansId = 176325;
	    private const uint UnfinishedPaintingId = 177287;
