...
namespace Honorbuddy.Quest_Behaviors.MountHyjal.BearsUpThere
{
	...
	public class BearsUpThere : CustomForcedBehavior
	{
		...
		public override string SubversionId { get { return ("$Id: BearsUpThere.cs 1721 2014-10-13 17:04:30Z chinajade $"); } }
		public override string SubversionRevision { get { return ("$Revision: 1721 $"); } }
