...
namespace Honorbuddy.QuestBehaviorCore.XmlElements
{
    public class VehicleAbilitiesType : QuestBehaviorXmlBase
    {
		...
		public override string SubversionId { get { return "$Id: VehicleAbilitiesType.cs 1777 2014-11-07 10:27:43Z mainhaxor $"; } }
		public override string SubversionRevision { get { return "$Rev: 1777 $"; } }
