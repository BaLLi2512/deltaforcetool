...
namespace Honorbuddy.Quest_Behaviors.Halt
{
	...
	public class Halt : CustomForcedBehavior
	{
		...
		public override string SubversionId { get { return ("$Id: Halt.cs 1897 2014-12-12 14:59:25Z Mainhaxor $"); } }
		public override string SubversionRevision { get { return ("$Revision: 1897 $"); } }
