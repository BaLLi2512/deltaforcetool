...
namespace Honorbuddy.Quest_Behaviors.Hooks
{
	...
	public class MountHook : CustomForcedBehavior
	{
        ...
        public override string SubversionId { get { return ("$Id: MountHook.cs 2188 2016-05-17 19:33:09Z Dogan $"); } }
        public override string SubversionRevision { get { return ("$Revision: 2188 $"); } }
