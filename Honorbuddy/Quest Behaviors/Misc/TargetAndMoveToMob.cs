...
namespace Honorbuddy.Quest_Behaviors.TargetAndMoveToMob
{
	...
	public class TargetAndMoveToMob : QuestBehaviorBase
	{
		...
		public override string SubversionId { get { return "$Id: TargetAndMoveToMob.cs 1844 2014-11-18 19:27:06Z Dogan $"; } }
		public override string SubversionRevision { get { return "$Rev: 1844 $"; } }
		#endregion
