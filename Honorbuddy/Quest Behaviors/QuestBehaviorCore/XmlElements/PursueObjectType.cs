...
namespace Honorbuddy.QuestBehaviorCore.XmlElements
{
    ...
    public abstract class PursueObjectTypeBase : QuestBehaviorXmlBase
    {
        ...
        public override string SubversionId { get { return "$Id: PursueObjectType.cs 1839 2014-11-18 06:11:55Z chinajade $"; } }
        public override string SubversionRevision { get { return "$Rev: 1839 $"; } }
