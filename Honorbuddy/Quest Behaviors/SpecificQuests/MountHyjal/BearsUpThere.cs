...
namespace Honorbuddy.Quest_Behaviors.MountHyjal.BearsUpThere
{
	...
	public class BearsUpThere : QuestBehaviorBase
	{
		...
		public override string SubversionId { get { return ("$Id: BearsUpThere.cs 2050 2015-04-23 18:41:27Z chinajade $"); } }
		public override string SubversionRevision { get { return ("$Revision: 2050 $"); } }
